...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_og5vi8r', 'template_9u6f198', form.current, '3OkQuXhinIkzbt8Tf')
      .then((result) => {
      ...
      <div className="container contact_container">
        <div className="contact_options">
          <article className='contact_option'>
            ...
            <a href="mailto:drotvensan@gmail.com" target="_blank">Send a message</a>
          </article>
          <article className='contact_option'>
            <FaTelegramPlane className='contact-icon'/>
            <h4>Telegram</h4>
            <h5>@vensandrot</h5>
            <a href="https://t.me/VensanDrot" target="_blank">Send a message</a>
          </article>
          <article className='contact_option'>
